...
public class HanoiTower {
	...
	public void solvePuzzle(String[] args) {
		...
		System.out.println("\nSolving the game step-by-step using " + levels + " levels.\n");
	 ...
	 *	to be completed by student ...
	 */
	public void hanoi(int pegNum, int src, int mid, int dst){
		if(pegNum == 1){
			...
			hanoi(pegNum - 1, src, dst, mid);
			System.out.println("[" + src + ", " + dst + "]");
			printTowers();
			moveDisk(src, dst);
			hanoi(pegNum - 1, mid, src, dst);
		}
	}
